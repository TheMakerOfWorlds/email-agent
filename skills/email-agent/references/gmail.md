...
For inbox organization, labels, attachment downloads, saved Gmail filters, or advanced search, read [mailbox commands](mailbox.md). These commands use explicit account IDs and bounded results.
